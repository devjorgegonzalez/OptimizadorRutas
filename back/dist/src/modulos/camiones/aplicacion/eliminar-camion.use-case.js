...
exports.EliminarCamionUseCase = void 0;
const common_1 = require("@nestjs/common");
const camion_repository_1 = require("../dominio/camion.repository");
let EliminarCamionUseCase = class EliminarCamionUseCase {
    camionRepository;
...
exports.EliminarCamionUseCase = EliminarCamionUseCase;
exports.EliminarCamionUseCase = EliminarCamionUseCase = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, common_1.Inject)(camion_repository_1.CAMION_REPOSITORY)),
    __metadata("design:paramtypes", [Object])
], EliminarCamionUseCase);
//# sourceMappingURL=eliminar-camion.use-case.js.map